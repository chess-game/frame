...
//添加一个新key
//func (this *JsonStream)Add(key string, value interface{}) bool {
//
//	for i:= uint32(1); i <= uint32(len(this.data)); i++ {
//		//{"EventId":9033802400002,"RetCode":100000}
//		fmt.Printf("len[%v]i[%v]\n",this.dataLength, i)
//		if this.data[uint32(len(this.data)) - i] == '}' {
//			switch reflect.ValueOf(value).Kind() {
//			case reflect.Int:
//				fallthrough
//			case reflect.Int32:
...
//				fallthrough
//			case reflect.Uint8:
//				d := fmt.Sprintf("%v,\"%v\":%v}", string(this.data[:(this.dataLength - i)]), key, value)
//				this.data = []byte(d)
//
//			case reflect.String:
//				d := fmt.Sprintf("%v,\"%v\":\"%v\"}", string(this.data[:(this.dataLength - i)]), key, value)
